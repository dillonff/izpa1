...
const Team = () => {
  ...
  useEffect(() => {
    ...
    paperImg.src = images.materials.paper;
    paperImg.onload = () =>
      setImagesLoaded((prev) => ({ ...prev, paper: true }));

    const wallsImg = new Image();
    wallsImg.src = images.materials.walls;
    wallsImg.onload = () =>
      setImagesLoaded((prev) => ({ ...prev, walls: true }));
  }, []);
    ...
    <div className="min-h-screen">
      ...
      >
        <div className="absolute inset-0">
          <img
            src={images.materials.paper}
            alt="Paper Texture"
            className={`w-full h-full object-cover scale-110 ${
              imagesLoaded.paper ? 'opacity-70' : 'opacity-0'
        ...
        <div className="container mx-auto px-4 relative z-20">
          ...
          >
            Our young, highly motivated team is united by a shared commitment to
            solving the housing crisis, promoting creativity and sustainability,
            and preserving cultural heritage through integrated, thoughtful
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={images.materials.walls}
            alt="Walls Texture"
            className={`w-full h-full object-cover ${
              imagesLoaded.walls ? 'opacity-30' : 'opacity-0'
            } transition-opacity duration-700`}
        ...
        <div className="container mx-auto px-4 relative z-10 text-white">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <motion.div
              className="relative pl-12 border-l-4 border-red-500"
              {...fadeIn}
            >
              <div className="absolute left-[-2.5rem] top-0 w-8 h-8 flex items-center justify-center">
                <svg
              ...
              <p className="text-gray-300 leading-relaxed">
                In-depth local industry experience from public and private
                sectors
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed">
                Streamline processes to deliver timely, cost-effective solutions
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed">
                Keep relationship across team and various stakeholders
              </p>
            </motion.div>
          </div>
        </div>
